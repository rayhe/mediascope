...
| # | Cluster | Aliases | Regex | Key Aliases | Notes |
|---|---------|---------|-------|-------------|-------|
| 81 | **Labor/Unions** | 19 | auto | UTAW, CWU, Alphabet Workers Union, SEIU, AFL-CIO, SAG-AFTRA, WGA, DGA, IATSE, Teamsters | Includes organizing verbs (`unionize`, `unionization`) and entertainment/media unions |
