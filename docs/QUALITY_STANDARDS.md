...
This ensures the correction pipeline is validated against real articles, not synthetic examples. All 175 annotated articles in `examples/sample_output/` follow this pattern.
