...
### `framing.py`
- **38 framing device types** organized in three tiers:
...
├── tests/                       # 878 tests across 34 test files (all from real articles)
