...
### `framing.py`
- **84 framing device types** organized in three tiers:
...
├── tests/                       # 1914 tests across 82 test files (all from real articles)
