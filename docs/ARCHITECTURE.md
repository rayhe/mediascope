...
### `framing.py`
- **59 framing device types** organized in three tiers:
...
├── tests/                       # 1259 tests across 49 test files (all from real articles)
