...
Raw Text
  ...
  └── (Optional) LLM score ─────┘          │
                                 ...
                                 (113 device types, 767 compiled regex)
                                           │
                                           ▼
...
│   └── sample_output/       # 202 annotated real-article analyses (see METHODOLOGY.md §17)
