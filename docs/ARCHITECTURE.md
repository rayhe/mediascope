...
│   └── sample_output/       # 162 annotated real-article analyses (see METHODOLOGY.md §17)
├── tests/                       # 2280 tests across 101 test files (all from real articles)
