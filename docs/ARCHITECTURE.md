...
### `framing.py`
- **58 framing device types** organized in three tiers:
...
├── tests/                       # 1255 tests across 49 test files (all from real articles)
