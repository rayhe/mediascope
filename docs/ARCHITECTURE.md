...
│   └── sample_output/       # 145 annotated real-article analyses (see METHODOLOGY.md §17)
├── tests/                       # 2148 tests across 91 test files (all from real articles)
