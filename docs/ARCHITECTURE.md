...
### `framing.py`
- **57 framing device types** organized in three tiers:
...
├── tests/                       # 1251 tests across 49 test files (all from real articles)
