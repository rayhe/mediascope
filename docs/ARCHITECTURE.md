...
Raw Text
  ...
  └── (Optional) LLM score ─────┘          │
                                 ...
                                 (113 device types, 775 compiled regex)
                                           │
                                           ▼
...
│   └── sample_output/       # 204 annotated real-article analyses (see METHODOLOGY.md §17)
├── tests/                       # 3114 tests across 141 test files (all from real articles)
