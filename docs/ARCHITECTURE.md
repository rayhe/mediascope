...
### `framing.py`
- **77 framing device types** organized in three tiers:
...
├── tests/                       # 1569 tests across 64 test files (all from real articles)
