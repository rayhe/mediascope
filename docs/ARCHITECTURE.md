...
### `framing.py`
- **93 framing device types** organized in three tiers:
...
│   └── sample_output/       # 146 annotated real-article analyses (see METHODOLOGY.md §17)
├── tests/                       # 2155 tests across 92 test files (all from real articles)
