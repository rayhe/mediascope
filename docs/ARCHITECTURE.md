...
### `framing.py`
- **31 framing device types** organized in three tiers:
...
├── tests/                       # 572 tests across 23 test files (all from real articles)
