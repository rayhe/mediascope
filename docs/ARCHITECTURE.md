...
### `framing.py`
- **90 framing device types** organized in three tiers:
...
├── tests/                       # 2087 tests across 88 test files (all from real articles)
