...
Raw Text
  ...
  └── (Optional) LLM score ─────┘          │
                                 ...
                                 (111 device types, 754 compiled regex)
                                           │
                                           ▼
...
### `framing.py`
- **111 framing device types** organized in three tiers:
