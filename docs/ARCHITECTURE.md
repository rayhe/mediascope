...
│   └── sample_output/       # 175 annotated real-article analyses (see METHODOLOGY.md §17)
├── tests/                       # 2495 tests across 111 test files (all from real articles)
