...
Raw Text
  ...
  └── (Optional) LLM score ─────┘          │
                                 ...
                                 (113 device types, 779 compiled regex)
                                           │
                                           ▼
...
│   └── sample_output/       # 205 annotated real-article analyses (see METHODOLOGY.md §17)
