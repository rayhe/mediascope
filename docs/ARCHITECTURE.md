...
### `framing.py`
- **80 framing device types** organized in three tiers:
...
├── tests/                       # 1631 tests across 66 test files (all from real articles)
