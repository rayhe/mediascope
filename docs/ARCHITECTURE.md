...
### `framing.py`
- **92 framing device types** organized in three tiers:
...
│   └── sample_output/       # 142 annotated real-article analyses (see METHODOLOGY.md §17)
