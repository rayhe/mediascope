...
### `framing.py`
- **83 framing device types** organized in three tiers:
...
├── tests/                       # 1720 tests across 70 test files (all from real articles)
