...
Raw Text
  ...
  └── (Optional) LLM score ─────┘          │
                                 ...
                                 (106 device types, 653 compiled regex)
                                           │
                                           ▼
...
├── tests/                       # 2745 tests across 124 test files (all from real articles)
