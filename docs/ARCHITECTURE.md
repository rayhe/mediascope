...
├── tests/                       # 10296 tests across 322 test files (all from real articles)
...
│   ├── test_type_d_02am_cross_validation_aug12.py # Type D 02:00 Aug 12 cross-validation: Mechanism #58 placement fix verification, publications section clean (9 pubs, no mechanism_ids), mechanisms 51-58 completeness, mechanism ID sequence integrity, test file sync. 7 classes, 19 tests
