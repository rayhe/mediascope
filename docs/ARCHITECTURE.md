...
### `framing.py`
- **75 framing device types** organized in three tiers:
...
├── tests/                       # 1461 tests across 57 test files (all from real articles)
