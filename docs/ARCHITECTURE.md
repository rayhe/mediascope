...
### `framing.py`
- **47 framing device types** organized in three tiers:
...
├── tests/                       # 1058 tests across 41 test files (all from real articles)
