...
### `framing.py`
- **102 framing device types** organized in three tiers:
...
│   └── sample_output/       # 179 annotated real-article analyses (see METHODOLOGY.md §17)
├── tests/                       # 2603 tests across 117 test files (all from real articles)
