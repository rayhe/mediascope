...
### `framing.py`
- **94 framing device types** organized in three tiers:
...
│   └── sample_output/       # 148 annotated real-article analyses (see METHODOLOGY.md §17)
├── tests/                       # 2165 tests across 93 test files (all from real articles)
