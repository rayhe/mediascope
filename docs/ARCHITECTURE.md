...
The toolkit uses a multi-layer correction pipeline with **9 distinct paths (A–I)** that addresses known VADER/TextBlob blind spots when scoring editorial prose:
...
### `framing.py`
- **67 framing device types** organized in three tiers:
...
├── tests/                       # 1360 tests across 53 test files (all from real articles)
