...
│   └── sample_output/       # 169 annotated real-article analyses (see METHODOLOGY.md §17)
├── tests/                       # 2392 tests across 106 test files (all from real articles)
