...
### `framing.py`
- **85 framing device types** organized in three tiers:
...
├── tests/                       # 1957 tests across 83 test files (all from real articles)
