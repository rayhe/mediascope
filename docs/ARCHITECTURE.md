...
### `framing.py`
- **39 framing device types** organized in three tiers:
...
├── tests/                       # 903 tests across 35 test files (all from real articles)
