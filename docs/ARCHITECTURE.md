...
### `framing.py`
- **101 framing device types** organized in three tiers:
...
│   └── sample_output/       # 163 annotated real-article analyses (see METHODOLOGY.md §17)
├── tests/                       # 2301 tests across 102 test files (all from real articles)
