...
Raw Text
  ...
  └── (Optional) LLM score ─────┘          │
                                 ...
                                 (108 device types, 720 compiled regex)
                                           │
                                           ▼
...
### `framing.py`
- **108 framing device types** organized in three tiers:
