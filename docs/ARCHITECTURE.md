...
│   └── sample_output/       # 173 annotated real-article analyses (see METHODOLOGY.md §17)
├── tests/                       # 2453 tests across 109 test files (all from real articles)
