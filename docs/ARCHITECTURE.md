...
Raw Text
  ...
  └── (Optional) LLM score ─────┘          │
                                 ...
                                 (106 device types, 717 compiled regex)
                                           │
                                           ▼
...
│   └── sample_output/       # 188 annotated real-article analyses (see METHODOLOGY.md §17)
├── tests/                       # 2820 tests across 127 test files (all from real articles)
