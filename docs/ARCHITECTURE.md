...
### `framing.py`
- **89 framing device types** organized in three tiers:
...
├── tests/                       # 2018 tests across 85 test files (all from real articles)
