...
### `framing.py`
- **37 framing device types** organized in three tiers:
...
├── tests/                       # 853 tests across 33 test files (all from real articles)
