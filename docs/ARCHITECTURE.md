...
Raw Text
  ...
  └── (Optional) LLM score ─────┘          │
                                 ...
                                 (109 device types, 743 compiled regex)
                                           │
                                           ▼
...
### `framing.py`
- **109 framing device types** organized in three tiers:
...
├── tests/                       # 3061 tests across 138 test files (all from real articles)
