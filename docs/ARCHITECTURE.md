...
Raw Text
  ...
  └── (Optional) LLM score ─────┘          │
                                 ...
                                 (113 device types, 770 compiled regex)
                                           │
                                           ▼
...
│   └── sample_output/       # 203 annotated real-article analyses (see METHODOLOGY.md §17)
