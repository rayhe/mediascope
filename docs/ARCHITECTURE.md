...
### `framing.py`
- **76 framing device types** organized in three tiers:
...
├── tests/                       # 1535 tests across 62 test files (all from real articles)
...
│   ├── test_topics.py           # Topic classification, all 26 buckets, confidence scoring, density normalization
