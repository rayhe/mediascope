...
Raw Text
  ...
  └── (Optional) LLM score ─────┘          │
                                 ...
                                 (104 device types, 696 compiled regex)
                                           │
                                           ▼
...
### `framing.py`
- **104 framing device types** organized in three tiers:
...
├── tests/                       # 2730 tests across 123 test files (all from real articles)
