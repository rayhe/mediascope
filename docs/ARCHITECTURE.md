...
### `framing.py`
- **69 framing device types** organized in three tiers:
...
├── tests/                       # 1388 tests across 54 test files (all from real articles)
