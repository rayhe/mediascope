...
Raw Text
  ...
  └── (Optional) LLM score ─────┘          │
                                 ...
                                 (112 device types, 759 compiled regex)
                                           │
                                           ▼
...
### `framing.py`
- **112 framing device types** organized in three tiers:
