...
| 105 | **Humanization** | E | Emotionally resonant personal details creating sympathy for affected individuals — timing of harm near life events, personal financial devastation, pregnancy context | "laid off [timeframe] before/after [life event]," "pregnant when [company action]," "[age] years old when [harm]" |
...
| 110 | **Success Paradox** | E | Headline/lede acknowledges objectively positive commercial news then pivots via "even as"/"despite" to a negative narrative that dominates the article's word count — uses genuine positive data as a Trojan horse for negative framing | "a hit even as privacy concerns pile up," "popular despite an increasingly prickly climate," "growth doesn't mean a tipping point isn't coming" |
| 111 | **Safeguard Inadequacy** | E | Introduces a technical or policy safeguard (privacy LED, opt-out, data deletion) then systematically undermines it as insufficient, circumventable, or performative — frames mitigation as theater, concluding no safeguard can ever be adequate | "privacy light ... but people might not see it," "growing market for disabling these indicators," "the option to opt out is no longer available," "workarounds to avoid the light" |
| 112 | **Platform Self-Incrimination** | E | Highlights that violations, circumvention services, or evidence against the company's own policies are found, sold, or promoted on the company's own platforms, marketplace, or ecosystem — frames the distribution channel as ironic self-undermining | "advertised on Meta's own platforms," "trended on Meta's own Threads app ... for the wrong reasons," "buy a cover from TikTok Shop," "listed on Facebook Marketplace" |
...
| **Experiential Authority** | Narrative & Editorial Architecture | First-person narration where the journalist becomes a user of the product/category, then converts their personal discomfort or negative experience into editorial authority harder to challenge than third-party criticism. Journalist's lived experience replaces sourced criticism as primary adversarial evidence. Distinguishing signals: first-person pronoun density, concession-pivot structure ("I found it useful... But it felt strange"), personal anecdote positioned as representative of societal concern. Distinct from editorial_aside (which uses parenthetical interjections, not sustained first-person narrative). | CNN "AI devices that see, listen and record" (Jul 26, 2026) — Catherine Thorbecke wears Meta glasses, Amazon Bee, Plaud Notepin S for months, converts personal awkwardness into evidence that recording wearables are socially inappropriate. | 1 | Needs 2+ more |
| **Dystopian Scenario Construction** | Narrative & Editorial Architecture | Opening an article with a speculative near-future scenario that presents the subject technology deployed at scale in everyday life, using second-person address ("picture this," "imagine") to place the reader inside a surveillance/dystopian frame before any facts are presented. Primes reader to evaluate subsequent information through a lens of unease. Distinct from speculative_framing (which projects vague negative futures mid-article) — dystopian_scenario_construction is specifically an opening gambit using immersive scene-setting. | CNN "AI devices that see, listen and record" (Jul 26, 2026) — "Picture this: On a normal workday, you and your coworkers walk around the office with tiny recorders clipped to your clothes" as opening paragraph. | 1 | Needs 2+ more |
