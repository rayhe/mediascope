...
MediaScope ships with career data for **70 journalists** across the 5 starter publications plus notable feeder outlets (The Verge, BuzzFeed News, Platformer, Reuters, Recode, WSJ, Bloomberg, The Telegraph, New Scientist, Gizmodo, The Daily Beast, Politico, and others). 66 of these have multi-publication careers suitable for migration analysis.
...
4. Shipping with verified starter data for **70 journalists** across 10+ publications, with 66 having multi-publication careers suitable for migration analysis
