...
MediaScope ships with career data for **177 journalists** across the 5 starter publications plus 330+ notable feeder outlets (The Verge, BuzzFeed News, Platformer, Reuters, Recode, WSJ, Bloomberg, The Telegraph, New Scientist, Gizmodo, The Daily Beast, Politico, Consumer Reports, The Information, and 195+ others). 173 of these have multi-publication careers suitable for migration analysis. The CareerTracker auto-detects **555 migrations** between publications from the career event timelines, using gap analysis to distinguish genuine job changes from concurrent freelance roles.
...
4. Shipping with verified starter data for **177 journalists** across 330+ publications, with 173 having multi-publication careers suitable for migration analysis
