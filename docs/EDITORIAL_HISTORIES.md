...
MediaScope ships with career data for **114 journalists** across the 5 starter publications plus notable feeder outlets (The Verge, BuzzFeed News, Platformer, Reuters, Recode, WSJ, Bloomberg, The Telegraph, New Scientist, Gizmodo, The Daily Beast, Politico, Consumer Reports, The Information, and 155+ others). 112 of these have multi-publication careers suitable for migration analysis.
...
4. Shipping with verified starter data for **114 journalists** across 170+ publications, with 112 having multi-publication careers suitable for migration analysis
