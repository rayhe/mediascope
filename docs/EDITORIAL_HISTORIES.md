...
MediaScope ships with career data for **213 journalists** across the 5 starter publications plus 380+ notable feeder outlets (The Verge, BuzzFeed News, Platformer, Reuters, Recode, WSJ, Bloomberg, The Telegraph, New Scientist, Gizmodo, The Daily Beast, Politico, Consumer Reports, The Information, and 195+ others). 205 of these have multi-publication careers suitable for migration analysis. The CareerTracker auto-detects **657 migrations** between publications from the career event timelines, using gap analysis to distinguish genuine job changes from concurrent freelance roles.
...
4. Shipping with verified starter data for **213 journalists** across 388+ publications, with 205 having multi-publication careers suitable for migration analysis
