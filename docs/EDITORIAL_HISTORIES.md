...
MediaScope ships with career data for **87 journalists** across the 5 starter publications plus notable feeder outlets (The Verge, BuzzFeed News, Platformer, Reuters, Recode, WSJ, Bloomberg, The Telegraph, New Scientist, Gizmodo, The Daily Beast, Politico, and others). 84 of these have multi-publication careers suitable for migration analysis.
...
4. Shipping with verified starter data for **87 journalists** across 130+ publications, with 84 having multi-publication careers suitable for migration analysis
