...
MediaScope ships with career data for **159 journalists** across the 5 starter publications plus 310+ notable feeder outlets (The Verge, BuzzFeed News, Platformer, Reuters, Recode, WSJ, Bloomberg, The Telegraph, New Scientist, Gizmodo, The Daily Beast, Politico, Consumer Reports, The Information, and 175+ others). 157 of these have multi-publication careers suitable for migration analysis. The CareerTracker auto-detects **509 migrations** between publications from the career event timelines, using gap analysis to distinguish genuine job changes from concurrent freelance roles.
...
4. Shipping with verified starter data for **159 journalists** across 310+ publications, with 157 having multi-publication careers suitable for migration analysis
