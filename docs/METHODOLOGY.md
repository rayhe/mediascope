...
MediaScope detects 70 framing device types, organized into three tiers: core devices (10 pattern-matched types covering fundamental editorial techniques), extended devices (54 added from real-article analysis), and structural devices (6 detected via post-pass heuristics rather than simple pattern matching).
