...
Articles are classified into 21 topic buckets to enable apples-to-apples comparison:
...
| **Framing device count** | Total devices from the 49-type taxonomy (§4) | Framing density — how many editorial techniques are deployed |
