...
MediaScope detects 32 framing device types, organized into three tiers: core devices (10 pattern-matched types covering fundamental editorial techniques), extended devices (19 added from real-article analysis), and structural devices (3 detected via post-pass heuristics rather than simple pattern matching).
...
| **Framing device count** | Total devices from the 31-type taxonomy (§4) | Framing density — how many editorial techniques are deployed |
