...
class TestFramingDeviceRegistry:
    ...
    def test_all_expected_types_registered(self):
        ...
        expected_pattern_types = {
            ...
            "confession_framing",
            # Latecomer narrative (1)
            "latecomer_narrative",
            # Regulatory shadow (1)
            "regulatory_shadow",
            # Editorial deflation (1)
            "editorial_deflation",
            # Denial contradiction (1)
            "denial_contradiction",
            # Worker replacement irony (1)
            ...
            # Commodification metaphor (1)
            "commodification_metaphor",
            # Analogy/metaphor (1)
            "analogy_metaphor",
            # Taxonomy framing (1)
            "taxonomy_framing",
            ...
            "repeated_disruption",
            # Expert contradiction (1) — credentialed source disputes company justification
            ...
            "precedent_framing",
            # Expert consensus authority (1) — multiple credentialed experts reinforcing same thesis
            "expert_consensus_authority",
            # Prescriptive solutionism (1) — actionable steps/checklists normalizing the underlying behavior
            ...
            # Narrative reframing (1) — explicitly dismissing surface narrative as incomplete
            "narrative_reframing",
            # Dismissive qualifier (1) — pejorative adjectives delegitimizing a viewpoint
            ...
            "analyst_authority",
            # Investor advisory (1) — author adopts investment-advisor posture directing reader behavior
            "investor_advisory",
            ...
            # Recovery narrative (1) — three-beat decline→catalyst→recovery structure
            "recovery_narrative",
            # Grudging concession (1) — positive action acknowledged but editorially minimized
            "grudging_concession",
            ...
            "recidivism_framing",
            # Reader positioning (1) — second-person concessive constructions presupposing agreement
            "reader_positioning",
            # No-comment implication (1) — "did not immediately respond" evasiveness framing
            "no_comment_implication",
            # Competitive guilt transfer (1) — linking product to competitor's scandal
            "competitive_guilt_transfer",
            # Consent alarm (1) — default opt-in / automatic enrollment as consent violation
            "consent_alarm",
            # Editorial character attack (3) — journalist's own character judgment as established fact
            "editorial_character_attack",
            # Surveillance creep — ambient always-on recording language
            "surveillance_creep",
            ...
            # Glasshole revival — 2013 pejorative revived against current smart glasses
            "glasshole_revival",
