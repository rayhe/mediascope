...
class TestFramingDeviceTypeCount:
    ...
    EXPECTED_TOTAL = 92
    EXPECTED_PATTERN_MATCHED = 85  # core + extended (in _DEVICE_PATTERNS)
...
class TestEmotionalLanguageCount:
    ...
    def test_emotional_language_count(self):
        ...
        assert len(EMOTIONAL_LANGUAGE) == 850, (
            f"Expected 850 emotional language terms, got {len(EMOTIONAL_LANGUAGE)}.\n"
...
class TestAdversarialDeviceListConsistency:
    ...
    EXPECTED_TOTAL_PATTERNS = 525  # sum(len(v) for v in _DEVICE_PATTERNS.values())
