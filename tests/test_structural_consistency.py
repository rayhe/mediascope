...
class TestEmotionalLanguageCount:
    ...
    def test_emotional_language_count(self):
        ...
        assert len(EMOTIONAL_LANGUAGE) == 654, (
            f"Expected 654 emotional language terms, got {len(EMOTIONAL_LANGUAGE)}.\n"
...
class TestAdversarialDeviceListConsistency:
    ...
    EXPECTED_TOTAL_PATTERNS = 282  # sum(len(v) for v in _DEVICE_PATTERNS.values())
