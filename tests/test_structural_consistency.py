...
class TestFramingDeviceTypeCount:
    ...
    EXPECTED_TOTAL = 48
    EXPECTED_PATTERN_MATCHED = 43  # core + extended (in _DEVICE_PATTERNS)
...
class TestEmotionalLanguageCount:
    ...
    def test_emotional_language_count(self):
        ...
        assert len(EMOTIONAL_LANGUAGE) == 669, (
...
class TestAdversarialDeviceListConsistency:
    ...
    EXPECTED_TOTAL_PATTERNS = 287  # sum(len(v) for v in _DEVICE_PATTERNS.values())
