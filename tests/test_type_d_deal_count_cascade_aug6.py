...
class TestXAIIntegration:
    ...
    def test_total_entities_at_least_9(self, entities):
        """Floor check: started at 8, grew to 9 (Samsung), 11 (Microsoft, Snowflake).
        Use >= to avoid breaking when later iterations add more entities."""
