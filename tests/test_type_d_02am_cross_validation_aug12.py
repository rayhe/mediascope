...
class TestMechanismIDSequenceIntegrity(unittest.TestCase):
    ...
    def test_max_mechanism_is_58(self):
        """The highest mechanism ID should be 58."""
        self.assertEqual(max(self.all_ids), 58,
                         f"Expected max mechanism_id=58, got {max(self.all_ids)}")

    def test_recent_mechanisms_contiguous(self):
        """Mechanisms 50-58 should form a contiguous sequence."""
