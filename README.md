...
| [FRAMING_REFERENCE.md](docs/FRAMING_REFERENCE.md) | **Quick-reference card for all 85 framing device types** — scannable lookup during article analysis |
...
MediaScope has **1957 tests** across 83 test files, each covering a different analytical capability:
