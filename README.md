...
2. **Detects entities** mentioned in coverage (companies, executives, products) using 81 clusters with 804 aliases and disambiguation filters (see [docs/ENTITY_REFERENCE.md](docs/ENTITY_REFERENCE.md))
...
Ships with verified career data for **218 journalists** across 390+ publications (683 auto-detected migrations). Notable high-value migrations include:
...
| [ENTITY_REFERENCE.md](docs/ENTITY_REFERENCE.md) | **Quick-reference card for all 81 entity clusters (804 aliases)** — disambiguation filters, cluster categories, custom regex patterns, pipeline interactions |
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 218 journalists, 683 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
...
MediaScope has **2230 tests** across 98 test files, each covering a different analytical capability:
