...
Ships with verified career data for **178 journalists** across 330+ publications (560 auto-detected migrations). Notable high-value migrations include:
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 178 journalists, 560 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
