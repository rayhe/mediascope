...
| Framing patterns | 717 | Compiled regex patterns across 99 pattern-based types |
...
MediaScope has **2820 tests** across 127 test files, each covering a different analytical capability:
