...
Ships with verified career data for **229 journalists** across 400+ publications (904 career-entry migrations). Notable high-value migrations include:
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 229 journalists, 712 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
