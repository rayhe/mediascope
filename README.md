...
| Framing patterns | 770 | Compiled regex patterns across 106 pattern-based types |
...
| Annotated articles | 203 | Full manual analysis in `examples/sample_output/` |
...
MediaScope has **3099 tests** across 140 test files, each covering a different analytical capability:
