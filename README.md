...
Ships with verified career data for **203 journalists** across 370+ publications (622 auto-detected migrations). Notable high-value migrations include:
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 203 journalists, 622 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
