...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 127 journalists, 408 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
...
MediaScope has **1388 tests** across 54 test files, each covering a different analytical capability:
