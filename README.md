...
MediaScope has **1155 tests** across 44 test files, each covering a different analytical capability:
...
| `test_delayed_defense_and_normalization.py` | 16 | Delayed defense (corporate response buried after 65% of article), industry normalization undercut (acknowledging industry-wide practice then singling out the target), headline boost strength (2.0× multiplier lifts child_safety above ai_development when headline signals the real topic). |
