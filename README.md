...
| Framing patterns | 670 | Compiled regex patterns across 94 pattern-based types |
...
| Journalists tracked | 230 | Career data with source URLs |
| Career-entry migrations | 909 | Across 418 distinct publications |
| Topic buckets | 29 | Standardized for cross-entity comparison |
| Tests | 2,495 | Across 111 test files |
...
Ships with verified career data for **230 journalists** across 420+ publications (909 career-entry migrations). Notable high-value migrations include:
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 230 journalists, 717 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
...
MediaScope has **2495 tests** across 111 test files, each covering a different analytical capability:
