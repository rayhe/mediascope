...
|---|---|---|
| Entity clusters | 86 | 852 aliases, 63 with custom regex, 22 auto-generated |
| Framing device types | 101 | 10 core + 84 extended + 7 structural (post-pass) |
| Framing patterns | 642 | Compiled regex patterns across 94 pattern-based types |
...
| Annotated articles | 163 | Full manual analysis in `examples/sample_output/` |
...
| Tests | 2,280 | Across 101 test files |
