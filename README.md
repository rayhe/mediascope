...
Ships with verified career data for **226 journalists** across 400+ publications (871 career-entry migrations, 699 auto-detected). Notable high-value migrations include:
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 226 journalists, 699 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
