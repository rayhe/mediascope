...
2. **Detects entities** mentioned in coverage (companies, executives, products) using 93 clusters with 887 aliases and disambiguation filters (see [docs/ENTITY_REFERENCE.md](docs/ENTITY_REFERENCE.md))
...
|---|---|---|
| Entity clusters | 93 | 887 aliases, 68 with custom regex, 25 auto-generated |
| Framing device types | 106 | 10 core + 89 extended + 7 structural (post-pass) |
| Framing patterns | 727 | Compiled regex patterns across 99 pattern-based types |
...
| [ENTITY_REFERENCE.md](docs/ENTITY_REFERENCE.md) | **Quick-reference card for all 93 entity clusters (887 aliases)** — disambiguation filters, cluster categories, custom regex patterns, pipeline interactions |
