...
Ships with verified career data for **207 journalists** across 370+ publications (638 auto-detected migrations). Notable high-value migrations include:
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 207 journalists, 638 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
