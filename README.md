...
| Framing patterns | 764 | Compiled regex patterns across 106 pattern-based types |
...
| Annotated articles | 201 | Full manual analysis in `examples/sample_output/` |
