...
| Framing patterns | 691 | Compiled regex patterns across 95 pattern-based types |
...
| Tests | 2,625 | Across 118 test files |
...
MediaScope has **2625 tests** across 118 test files, each covering a different analytical capability:
