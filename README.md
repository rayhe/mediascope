...
MediaScope has **3785 tests** across 162 test files, each covering a different analytical capability:
...
| `test_cross_platform_financial_incentives.py` | 58 | Cross-platform financial incentive matrix: 17 competitor revenue streams (OpenAI, Amazon Rufus+Alexa+, Google News AI pilot, Microsoft PCM, ProRata AI) across 7/8 MediaScope publications vs 0 Meta deals; per-publisher deal breakdowns with source URLs and dates; Condé Nast leads (4 deals), FT/Vox Media (3 each); Google pilot coercive Showcase sunset; NYT paradox (suing OpenAI while paying Amazon); Gizmodo clean control (0 deals, still adversarial); aggregate incentive gradient statistical note |
