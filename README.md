...
| `test_topics.py` | 28 | Topic classification: all 18 standardized topic buckets, confidence scoring (keyword coverage + density), top-N filtering, custom topic injection, multi-topic articles, edge cases |
