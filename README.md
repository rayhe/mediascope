...
| Framing patterns | 775 | Compiled regex patterns across 106 pattern-based types |
...
MediaScope has **3114 tests** across 141 test files, each covering a different analytical capability:
