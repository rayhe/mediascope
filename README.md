...
2. **Detects entities** mentioned in coverage (companies, executives, products) using 86 clusters with 863 aliases and disambiguation filters (see [docs/ENTITY_REFERENCE.md](docs/ENTITY_REFERENCE.md))
...
|---|---|---|
| Entity clusters | 86 | 863 aliases, 63 with custom regex, 23 auto-generated |
...
| Journalists tracked | 228 | Career data with source URLs |
| Career-entry migrations | 900 | Across 416 distinct publications |
| Topic buckets | 29 | Standardized for cross-entity comparison |
| Tests | 2,349 | Across 104 test files |
...
Ships with verified career data for **228 journalists** across 400+ publications (900 career-entry migrations). Notable high-value migrations include:
...
| [FRAMING_REFERENCE.md](docs/FRAMING_REFERENCE.md) | **Quick-reference card for all 101 framing device types** — scannable lookup during article analysis |
...
| [ENTITY_REFERENCE.md](docs/ENTITY_REFERENCE.md) | **Quick-reference card for all 86 entity clusters (863 aliases)** — disambiguation filters, cluster categories, custom regex patterns, pipeline interactions |
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 228 journalists, 710 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
...
MediaScope has **2373 tests** across 105 test files, each covering a different analytical capability:
