...
| Journalists tracked | 248 | Career data with source URLs |
| Career-entry migrations | 963 | Across 433+ publications |
...
Ships with verified career data for **248 journalists** (60 with structured education records) across 435+ publications (963 career-entry migrations). Notable high-value migrations include:
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 248 journalists, 750 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
