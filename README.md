...
2. **Detects entities** mentioned in coverage (companies, executives, products) using 86 clusters with 852 aliases and disambiguation filters (see [docs/ENTITY_REFERENCE.md](docs/ENTITY_REFERENCE.md))
...
| [ENTITY_REFERENCE.md](docs/ENTITY_REFERENCE.md) | **Quick-reference card for all 86 entity clusters (852 aliases)** — disambiguation filters, cluster categories, custom regex patterns, pipeline interactions |
...
MediaScope has **2349 tests** across 104 test files, each covering a different analytical capability:
