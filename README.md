...
| Framing device types | 104 | 10 core + 87 extended + 7 structural (post-pass) |
| Framing patterns | 696 | Compiled regex patterns across 97 pattern-based types |
...
| [FRAMING_REFERENCE.md](docs/FRAMING_REFERENCE.md) | **Quick-reference card for all 104 framing device types** — scannable lookup during article analysis |
...
MediaScope has **2730 tests** across 123 test files, each covering a different analytical capability:
