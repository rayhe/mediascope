...
| Framing patterns | 714 | Compiled regex patterns across 99 pattern-based types |
...
| Tests | 2,730 | Across 123 test files |
...
Ships with verified career data for **239 journalists** across 429+ publications (932 career-entry migrations). Notable high-value migrations include:
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 239 journalists, 731 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
...
MediaScope has **2745 tests** across 124 test files, each covering a different analytical capability:
