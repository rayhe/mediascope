...
| Framing patterns | 666 | Compiled regex patterns across 94 pattern-based types |
...
| Annotated articles | 173 | Full manual analysis in `examples/sample_output/` |
...
| Tests | 2,453 | Across 109 test files |
...
MediaScope has **2453 tests** across 109 test files, each covering a different analytical capability:
