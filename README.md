...
| Framing device types | 109 | 10 core + 92 extended + 7 structural (post-pass) |
...
| Tests | 3,061 | Across 138 test files |
...
| [FRAMING_REFERENCE.md](docs/FRAMING_REFERENCE.md) | **Quick-reference card for all 109 framing device types** — scannable lookup during article analysis |
...
MediaScope has **3061 tests** across 138 test files, each covering a different analytical capability:
