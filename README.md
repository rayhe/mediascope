...
MediaScope has **1098 tests** across 42 test files, each covering a different analytical capability:
...
| `test_cannes_contractors.py` | 27 | Wired "Cannes" contractors story: Scale AI/Covalen/Character.AI AI-Infrastructure clustering, catastrophizing "death of" proper-noun exclusion, Outlook software-product source exclusion, deception/impersonation loaded_language patterns, Business Insider/Daily Beast source fragment leak prevention, headline-aware topic boosting |
