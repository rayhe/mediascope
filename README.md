...
| [`careers_demo.py`](examples/careers_demo.py) | **NEW:** Editorial Histories module: career timelines for 113 journalists, 290 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
