...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 117 journalists, 355 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
...
MediaScope has **1180 tests** across 44 test files, each covering a different analytical capability:
