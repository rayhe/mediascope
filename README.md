...
| Framing device types | 108 | 10 core + 91 extended + 7 structural (post-pass) |
| Framing patterns | 736 | Compiled regex patterns across 101 pattern-based types |
...
| [FRAMING_REFERENCE.md](docs/FRAMING_REFERENCE.md) | **Quick-reference card for all 108 framing device types** — scannable lookup during article analysis |
