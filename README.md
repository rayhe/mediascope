...
| Framing patterns | 767 | Compiled regex patterns across 106 pattern-based types |
...
| Annotated articles | 202 | Full manual analysis in `examples/sample_output/` |
