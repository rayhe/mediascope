...
| Framing patterns | 696 | Compiled regex patterns across 95 pattern-based types |
...
| Tests | 2,706 | Across 122 test files |
...
MediaScope has **2706 tests** across 122 test files, each covering a different analytical capability:
