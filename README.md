...
Ships with verified career data for **208 journalists** across 380+ publications (644 auto-detected migrations). Notable high-value migrations include:
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 208 journalists, 644 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
