...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 157 journalists, 500 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
...
MediaScope has **1456 tests** across 57 test files, each covering a different analytical capability:
