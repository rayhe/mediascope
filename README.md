...
| [`careers_demo.py`](examples/careers_demo.py) | **NEW:** Editorial Histories module: career timelines for 108 journalists, 290 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
...
MediaScope has **1133 tests** across 43 test files, each covering a different analytical capability:
