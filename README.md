...
| Framing device types | 110 | 10 core + 93 extended + 7 structural (post-pass) |
| Framing patterns | 743 | Compiled regex patterns across 102 pattern-based types |
...
| Journalists tracked | 247 | Career data with source URLs |
| Career-entry migrations | 962 | Across 433+ publications |
| Topic buckets | 29 | Standardized for cross-entity comparison |
| Tests | 3,078 | Across 139 test files |
...
Ships with verified career data for **247 journalists** (60 with structured education records) across 435+ publications (962 career-entry migrations). Notable high-value migrations include:
...
| [FRAMING_REFERENCE.md](docs/FRAMING_REFERENCE.md) | **Quick-reference card for all 110 framing device types** — scannable lookup during article analysis |
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 247 journalists, 749 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
...
MediaScope has **3078 tests** across 139 test files, each covering a different analytical capability:
