...
Ships with verified career data for **213 journalists** across 388+ publications (657 auto-detected migrations). Notable high-value migrations include:
...
| [FRAMING_REFERENCE.md](docs/FRAMING_REFERENCE.md) | **Quick-reference card for all 94 framing device types** — scannable lookup during article analysis |
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 213 journalists, 657 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
...
MediaScope has **2165 tests** across 93 test files, each covering a different analytical capability:
