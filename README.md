...
| Annotated articles | 162 | Full manual analysis in `examples/sample_output/` |
...
MediaScope has **2280 tests** across 101 test files, each covering a different analytical capability:
