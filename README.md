...
| Framing patterns | 636 | Compiled regex patterns across 90 pattern-based types |
| Emotional language terms | 931 | Domain-specific lexicon for editorial EI scoring |
...
| Career-entry migrations | 893 | Across 412 distinct publications |
...
Ships with verified career data for **227 journalists** across 412 publications (893 career-entry migrations, 703 auto-detected). Notable high-value migrations include:
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 227 journalists, 703 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
...
| `test_recidivism_framing.py` | 25 | Recidivism framing device (#97): entity framed as serial offender through temporal recurrence markers — "once again caught," "has a long history of violations," "serial violator," "pattern of," "track record of failures," "continues to violate" — distinct from repeated_disruption (organizational instability); 20 positive tests, 5 negative guards including positive-context filtering |
