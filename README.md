...
Ships with verified career data for **217 journalists** across 390+ publications (680 auto-detected migrations). Notable high-value migrations include:
...
| [`careers_demo.py`](examples/careers_demo.py) | Editorial Histories module: career timelines for 217 journalists, 680 auto-detected migrations, DiD natural experiment setup, and notable career pipelines |
...
MediaScope has **2209 tests** across 96 test files, each covering a different analytical capability:
