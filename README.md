...
| Framing patterns | 659 | Compiled regex patterns across 94 pattern-based types |
...
| Annotated articles | 170 | Full manual analysis in `examples/sample_output/` |
...
| Tests | 2,437 | Across 108 test files |
...
MediaScope has **2437 tests** across 108 test files, each covering a different analytical capability:
