...
EMOTIONAL_LANGUAGE: list[str] = [
    ...
    "turmoil", "tumult",
    "chafed", "chafing",
    "poaching", "poaching war", "talent war",
    "upend", "upended", "upending",
    "personnel churn", "churn",
    "shakes up", "shaking up", "shake-up", "shakeup",
    ...
    "attack", "attacker", "attackers", "attacked", "attacking",
    "hijack", "hijacked", "hijacking", "hijackers",
    "compromised", "compromise",
    "malicious", "malware",
    "blackmail", "blackmailed", "blackmailing",
    "defaced", "defacing", "defacement",
    "snafu", "snafus",
    "shedding",
