...
DEFAULT_ENTITY_CLUSTERS: ClusterDict = {
    ...
    "AI Infrastructure": {
        ...
        "regex": r"(?<!\w)(Scale AI|Alexandr Wang|Covalen|Character\.?AI)(?!\w)",
    },
}
