...
TOPIC_KEYWORDS: dict[str, list[str]] = {
    ...
    "ai_development": [
        ...
        "neural network", "AI model", "AI system", "AI safety",
        "AI regulation", "AI ethics", "foundation model",
        "training data", "AI assistant", "chatbot", "AI agent",
        "AI research", "transformer model", "diffusion model",
