...
1. **expert_consensus_authority misclassification:** "filings are sealed, but at a court hearing in June they said" is procedural sourcing, not authority framing. The toolkit's regex for this category may be too broad.
2. **"violation" as loaded_language:** In COPPA litigation context, "violation" is statutory language (the actual legal term for each discrete breach). Detecting it as loaded language is technically correct by the pattern but semantically debatable for legal reporting where the word is used in its technical sense.
3. **Missing: strategic_disclosure framing.** Meta chose to disclose the $1.4T figure in their court filing — a litigation PR tactic to make the states' penalty look absurd by juxtaposing it with market cap. The toolkit detects scale_magnitude but doesn't distinguish between editorial magnitude-framing and party-strategic magnitude-framing.
